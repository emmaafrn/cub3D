...
SRC =	parsing/checkelements.c parsing/cub.c parsing/ft_strtrim.c parsing/ft_substr.c parsing/get_next_line.c\
		...
		cub3d.c vectors.c check_intersections.c rectif_pos.c sprites_stuff.c save.c check_arguments.c\
...
CFLAGS = -I. -Wall -Wextra -Werror -g3 -Ofast -flto -march=native -ffast-math
